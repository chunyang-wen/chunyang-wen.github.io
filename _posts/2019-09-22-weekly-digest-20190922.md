...
The medium-diffculty problems require a more careful analysis of the problem themselves and the
implementation normmaly is a little longer. You should try to come out with a simple solution and
try to optimize it. It is hard for me to solve multiple problems at a single night.
...
Usually we should call erase function between the resulting iterator returned and then end iterator.
